import { mudarCarrinho } from 'Store/Reduces/Carrinho';
import { mudarFavorito } from '../../Store/Reduces/Itens';
...
export default function Item(props){
    ...
    const dispatch = useDispatch(); // Certifique-se de que este hook está sendo chamado dentro do componente funcional
